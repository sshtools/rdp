...
public class RdpApplet extends Applet {
	...
	public void paint(Graphics g) {
		...
		if (!redirectOutput)
			g.drawString("Launching Elusiva Everywhere session...", x, y);
	...
	public void start() {
		...
		for (Object[] obj = { tok, args = new String[tok.countTokens()], new int[] { 0 } }; ((StringTokenizer) obj[0])
			.hasMoreTokens(); ((String[]) obj[1])[((int[]) obj[2])[0]++] = ((StringTokenizer) obj[0]).nextToken()) {
		}
